...
![image](https://user-images.githubusercontent.com/67427045/214098559-758c9a1d-8fc4-47ca-bb5b-ef96faff668f.png)<br>
...
The name and passphrase will be salted and encrypted. The result is feed to a QR Code generator.<br>
<br>
This way the QR Code becomes the public key. If the QR Code gets decrypted, the result is just the encrypted name and passphrase.(useless)<br>
Only the owner of the name and the passphrase can re-create the exact same QR Code. (inside the app)
